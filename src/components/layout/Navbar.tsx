...
export default function Navbar() {
  ...
  return (
    ...
    >
      <div className="w-full max-w-[1400px] mx-auto px-4 sm:px-8 h-20 flex items-center justify-between">
        {/* LOGO */}
        ...
        <button
          ...
          className="lg:hidden text-slate-700 p-2 rounded-lg bg-slate-100 hover:bg-slate-200 transition-colors"
